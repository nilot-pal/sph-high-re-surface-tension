...
enough to absorb what is left. Run 5 is the case of interest (the physical droplet, at Re 7155), and it is the opposite corner on both factors.
...
## Studies E and F (two single-factor checks **E) artificial viscosity coefficient.** alpha = 0.03, the value from Yang *et al.*, against
