/**
 * Square droplet at high Reynolds number.
 *
 * This is the stock SPHinXsys example
 *   tests/2d_examples/test_2d_square_droplet/src/droplet.cpp   (v1.0-beta.08)
 * with two constants changed: rho0_f 1.0 -> 1000.0 and rho0_a 0.001 -> 1.0.
 * The density ratio (1000) and viscosity ratio (100) are unchanged, so only Re moves,
 * by three orders of magnitude.
 *
 * Drop this in place of the stock droplet.cpp and build the example as normal.
 * Expected: the droplet never settles, and by t ~ 0.4 the fluid particles have left
 * the domain. Against the stock file, which relaxes to a circle at rest.
 *
 * Original file Copyright (c) 2017-2023 Xiangyu Hu and the SPHinXsys developers,
 * Apache License 2.0. Modified by Nilotpal Chakraborty, 2023.
 */
/**
 * @file 	droplet.cpp
...
//	Material parameters.
//----------------------------------------------------------------------
Real rho0_f = 1000.0;    /**< Reference density of water. CHANGED from 1.0 */
Real rho0_a = 1.0;       /**< Reference density of air. CHANGED from 0.001 */
